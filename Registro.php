...
if (isset($_POST['nombre_usuario']) && isset($_POST['nombre_completo']) && isset($_POST['correo']) && isset($_POST['contrasena']) && isset($_POST['telefono']) && isset($_POST['direccion'])) {
    ...
    $sql = "INSERT INTO viv_perfilesusuario (NombreUsuario, NombreCompleto, CorreoElectronico, ContrasenaHash, FechaRegistro, FechaUltimoAcceso, Rol, Activo, Direccion)
