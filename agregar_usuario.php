...
<body>
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['confirmar_creacion'])) {
        ...
        $sql = "INSERT INTO viv_perfilesusuario (NombreUsuario, NombreCompleto, CorreoElectronico, Direccion, Telefono, ContrasenaHash, Rol, Activo) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
        $stmt = $conexion->prepare($sql);
        $stmt->bind_param("ssssssii", $nombre_usuario, $nombre_completo, $correo_electronico, $direccion, $telefono, $contraseña, $rol, $activo);
